...
<main class="p-4">
	...
	<div class="grid grid-cols-4 gap-4">
		...
		<!-- Add VOD pseudo card -->
		<div
			class="vod-card flex min-h-[180px] cursor-pointer flex-col items-center justify-center gap-2 overflow-hidden rounded-md border border-dashed border-amber-400/40 bg-black/60 shadow-lg transition-transform duration-200 hover:scale-105 hover:border-amber-300"
			onclick={openAddVodDialog}
		>
			<span class="text-4xl text-amber-300">+</span>
			<span class="text-lg font-semibold text-amber-200">Add VOD</span>
		</div>
	</div>
</main>
